<template>
  <div v-if="isShowModal" class="fixed inset-0 z-[99999] flex items-center justify-center p-4">
    ...
    <div
      ...
      <div
        class="absolute -top-7 left-1/2 -translate-x-1/2 w-14 h-14 bg-amber-50 border-4 border-white text-amber-500 rounded-full flex items-center justify-center shadow-md z-20">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
          ...
          class="text-amber-500 w-6.5 h-6.5">
      ...
      <div class="px-6 pt-10 pb-4 shrink-0 bg-white rounded-t-[24px]">
        <div class="flex flex-col items-center text-center">
          ...
          <p class="text-sm font-semibold text-gray-400 text-center px-4">
            Congratulations! Your premium account is now active.
          </p>
        </div>
      </div>
          ...
          <div v-for="(item, index) in proFeatures" :key="index" class="flex items-center gap-3">
            ...
            <div class="w-6 h-6 rounded-full bg-teal-100 text-teal-500 flex items-center justify-center flex-shrink-0">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                class="stroke-teal-600 stroke-[3.5] stroke-linecap-round stroke-linejoin-round">
