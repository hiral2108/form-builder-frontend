      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all qcb-modal-content">
        <div class="px-6 py-5 border-b border-gray-100">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-lg font-semibold text-gray-900 m-0!">Delete All Leads</h3>
        ...
        <div class="px-6 py-6">
          <div class="text-center">
            <p class="text-gray-800 font-medium mb-2! mt-0! text-base!">Are you sure you want to delete all leads?</p>
