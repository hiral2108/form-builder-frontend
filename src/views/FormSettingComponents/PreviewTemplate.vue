<template>
  <div class="w-full flex flex-col items-center">
    ...
    <div class="mt-4 flex justify-center hidden lg:flex">
      <RadioTypeSelector v-model="activeDevice" :options="deviceOptions" :columns="2" name="preview-device-selector" />
    </div>
    ...
    <Teleport to="body">
      <ModalComponent
        ...
        <div class="flex flex-col items-center max-h-[80vh] scrollbar-thin">
          ...
          <div class="w-full max-w-[500px] h-[500px] flex items-center justify-center flex-shrink-0">
            <div
              :class="[
...
<script setup lang="ts">
  ...
  const deviceOptions = [
    {
      label:
        '<svg class="w-4.5 h-4.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 16H20V5H4V16ZM13 18V20H17V22H7V20H11V18H2.9918C2.44405 18 2 17.5511 2 16.9925V4.00748C2 3.45107 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44892 22 4.00748V16.9925C22 17.5489 21.5447 18 21.0082 18H13Z"></path></svg>',
      value: "desktop",
    },
    {
      label:
        '<svg class="w-4.5 h-4.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M7 4V20H17V4H7ZM6 2H18C18.5523 2 19 2.44772 19 3V21C19 21.5523 18.5523 22 18 22H6C5.44772 22 5 21.5523 5 21V3C5 2.44772 5.44772 2 6 2ZM12 17C12.5523 17 13 17.4477 13 18C13 18.5523 12.5523 19 12 19C11.4477 19 11 18.5523 11 18C11 17.4477 11.4477 17 12 17Z"></path></svg>',
      value: "mobile",
    },
  ];
</script>
