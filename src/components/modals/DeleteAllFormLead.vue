<template>
  <ModalComponent
    :isShowModal="isDeleteAllModalOpen"
    :closeModal="!isDeleting"
    headerTitle="Delete All Submissions"
    ...
    actionButtonTypeTwoText="Delete All Submissions"
  ...
  >
    <div class="text-left">
      <p class="text-slate-800 font-semibold mb-2 mt-0 text-base">Are you sure you want to delete all submissions?</p>
      <p class="text-sm text-slate-500 my-0">This submissions settings will be permanently removed from your account.</p>
    </div>
  </ModalComponent>
</template>
