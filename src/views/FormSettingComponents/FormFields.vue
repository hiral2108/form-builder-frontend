          ...
          <button
            ...
            <div class="flex-grow flex flex-row flex-wrap items-center gap-x-2 gap-y-1 min-w-0">
              ...
              <span
                ...
                class="px-1.5 pt-0.5 pb-1 rounded-full text-[8px] font-bold bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-sm uppercase tracking-wider scale-90 flex-shrink-0 origin-left">
                Pro
              </span>
            </div>
          </button>
