<template>
  <ModalComponent
    :isShowModal="isDeleteModalOpen"
    :closeModal="!isDeleting"
    headerTitle="Delete Submission"
    ...
    actionButtonTypeTwoText="Delete Submission"
  ...
  >
    <div class="text-left">
      <p class="text-slate-800 font-semibold mb-2 mt-0 text-base">Are you sure you want to delete this submission?</p>
      <p class="text-sm text-slate-500 my-0">This submission settings will be permanently removed from your account.</p>
    </div>
  </ModalComponent>
</template>
